...
OUTPUT_BASE_DIR="/Users/hernandezj45/Desktop/Repositories/Scaling-Tournament-Selection/Experiments/Scaling"
...
for DATASET_INFO in "${DATASETS[@]}"; do
    ...
    echo "  Completed: ${DATASET} (41 replicates, seeds $((BASE_SEED + 1 + OFFSET)) to $((BASE_SEED + 41 + OFFSET)))"
    echo ""
