...
Directory structure: RESULTS/Task/Pop500_Scaling100_Splits_60_20_20/Selection/Rep_i/test_mse.txt
"""
...
def compile_results(base_dir='RESULTS'):
    ...
    for task_dir in sorted(base_path.iterdir()):
        ...
        scaling_dir = task_dir / 'Pop500_Scaling100_Splits_60_20_20'
        if not scaling_dir.exists() or not scaling_dir.is_dir():
            print(f"  Warning: Pop500_Scaling100_Splits_60_20_20 directory not found in {task}")
            continue
