...
Directory structure: RESULTS/Task/Scaling_400/Selection/Rep_i/test_mse.txt
"""
...
def compile_results(base_dir='RESULTS'):
    ...
    for task_dir in sorted(base_path.iterdir()):
        ...
        scaling_dir = task_dir / 'Scaling_400'
        if not scaling_dir.exists() or not scaling_dir.is_dir():
            print(f"  Warning: Scaling_400 directory not found in {task}")
            continue
